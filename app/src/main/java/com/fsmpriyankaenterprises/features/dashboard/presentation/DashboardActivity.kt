package com.fsmpriyankaenterprises.features.dashboard.presentation
...
import com.fsmpriyankaenterprises.*
import com.fsmpriyankaenterprises.R
import com.fsmpriyankaenterprises.app.*
import com.fsmpriyankaenterprises.app.NewFileUtils.browseDocuments
import com.fsmpriyankaenterprises.app.NewFileUtils.browsePDFDocuments
import com.fsmpriyankaenterprises.app.NewFileUtils.getExtension
import com.fsmpriyankaenterprises.app.domain.*
import com.fsmpriyankaenterprises.app.types.DashboardType
import com.fsmpriyankaenterprises.app.types.FragType
import com.fsmpriyankaenterprises.app.types.TopBarConfig
import com.fsmpriyankaenterprises.app.uiaction.DisplayAlert
import com.fsmpriyankaenterprises.app.utils.*
import com.fsmpriyankaenterprises.app.utils.AppUtils.Companion.isProfile
import com.fsmpriyankaenterprises.base.BaseResponse
import com.fsmpriyankaenterprises.base.presentation.BaseActivity
import com.fsmpriyankaenterprises.base.presentation.BaseFragment
import com.fsmpriyankaenterprises.features.NewQuotation.*
import com.fsmpriyankaenterprises.features.NewQuotation.api.GetQuotRegProvider
import com.fsmpriyankaenterprises.features.NewQuotation.model.ViewDetailsQuotResponse
import com.fsmpriyankaenterprises.features.SearchLocation.SearchLocationFragment
import com.fsmpriyankaenterprises.features.SearchLocation.locationInfoModel
import com.fsmpriyankaenterprises.features.TA.ViewAllTAListFragment
import com.fsmpriyankaenterprises.features.achievement.AchievementFragment
import com.fsmpriyankaenterprises.features.activities.presentation.*
import com.fsmpriyankaenterprises.features.addAttendence.*
import com.fsmpriyankaenterprises.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.fsmpriyankaenterprises.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.fsmpriyankaenterprises.features.addAttendence.model.GetReportToFCMResponse
import com.fsmpriyankaenterprises.features.addAttendence.model.GetReportToResponse
import com.fsmpriyankaenterprises.features.addAttendence.model.Leave_list_Response
import com.fsmpriyankaenterprises.features.addorder.presentation.AddOrderFragment
...
import com.fsmpriyankaenterprises.features.addshop.presentation.AddShopFragment
import com.fsmpriyankaenterprises.features.addshop.presentation.OTPVerificationDialog
import com.fsmpriyankaenterprises.features.addshop.presentation.ScanImageFragment
import com.fsmpriyankaenterprises.features.addshop.presentation.ShowCardDetailsDialog
import com.fsmpriyankaenterprises.features.alarm.model.AlarmData
import com.fsmpriyankaenterprises.features.alarm.presetation.AttendanceReportFragment
import com.fsmpriyankaenterprises.features.alarm.presetation.PerformanceReportFragment
import com.fsmpriyankaenterprises.features.alarm.presetation.VisitReportDetailsFragment
import com.fsmpriyankaenterprises.features.alarm.presetation.VisitReportFragment
import com.fsmpriyankaenterprises.features.attendance.AttendanceFragment
import com.fsmpriyankaenterprises.features.attendance.api.AttendanceRepositoryProvider
import com.fsmpriyankaenterprises.features.attendance.model.AttendanceRequest
import com.fsmpriyankaenterprises.features.attendance.model.AttendanceResponse
import com.fsmpriyankaenterprises.features.averageshop.presentation.AverageShopFragment
import com.fsmpriyankaenterprises.features.avgorder.presentation.AverageOrderFragment
import com.fsmpriyankaenterprises.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.fsmpriyankaenterprises.features.beatCustom.TeamBeatListFragment
import com.fsmpriyankaenterprises.features.billing.presentation.AddBillingFragment
import com.fsmpriyankaenterprises.features.billing.presentation.BillingDetailsFragment
import com.fsmpriyankaenterprises.features.billing.presentation.BillingListFragment
import com.fsmpriyankaenterprises.features.changepassword.presentation.ChangePasswordDialog
import com.fsmpriyankaenterprises.features.chat.model.ChatListDataModel
import com.fsmpriyankaenterprises.features.chat.model.ChatUserDataModel
import com.fsmpriyankaenterprises.features.chat.model.GroupUserDataModel
import com.fsmpriyankaenterprises.features.chat.presentation.*
import com.fsmpriyankaenterprises.features.chatbot.presentation.ChatBotFragment
import com.fsmpriyankaenterprises.features.chatbot.presentation.ChatBotShopListFragment
import com.fsmpriyankaenterprises.features.chatbot.presentation.ReportsFragment
import com.fsmpriyankaenterprises.features.chatbot.presentation.SelectLanguageDialog
import com.fsmpriyankaenterprises.features.commondialog.presentation.CommonDialog
import com.fsmpriyankaenterprises.features.commondialog.presentation.CommonDialogClickListener
import com.fsmpriyankaenterprises.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.fsmpriyankaenterprises.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.fsmpriyankaenterprises.features.commondialogsinglebtn.OnDialogClickListener
import com.fsmpriyankaenterprises.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.fsmpriyankaenterprises.features.dailyPlan.prsentation.AllShopListFragment
import com.fsmpriyankaenterprises.features.dailyPlan.prsentation.DailyPlanListFragment
import com.fsmpriyankaenterprises.features.dailyPlan.prsentation.PlanDetailsFragment
import com.fsmpriyankaenterprises.features.damageProduct.ShopDamageProductListFrag
import com.fsmpriyankaenterprises.features.damageProduct.ShopDamageProductSubmitFrag
import com.fsmpriyankaenterprises.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.fsmpriyankaenterprises.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.fsmpriyankaenterprises.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.fsmpriyankaenterprises.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.fsmpriyankaenterprises.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.fsmpriyankaenterprises.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.fsmpriyankaenterprises.features.dashboard.presentation.model.ContentListResponseModel
import com.fsmpriyankaenterprises.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.fsmpriyankaenterprises.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.fsmpriyankaenterprises.features.device_info.presentation.DeviceInfoListFragment
import com.fsmpriyankaenterprises.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.fsmpriyankaenterprises.features.document.DocumentRepoFeatureNewFragment
import com.fsmpriyankaenterprises.features.document.presentation.DocumentListFragment
import com.fsmpriyankaenterprises.features.document.presentation.DocumentTypeListFragment
import com.fsmpriyankaenterprises.features.document.presentation.OpenFileWebViewFragment
import com.fsmpriyankaenterprises.features.dymanicSection.presentation.AddDynamicFragment
import com.fsmpriyankaenterprises.features.dymanicSection.presentation.AllDynamicListFragment
import com.fsmpriyankaenterprises.features.dymanicSection.presentation.DynamicListFragment
import com.fsmpriyankaenterprises.features.dymanicSection.presentation.EditDynamicFragment
import com.fsmpriyankaenterprises.features.gpsDisabilityScreen.GpsDisableFragment
import com.fsmpriyankaenterprises.features.home.presentation.HomeFragment
import com.fsmpriyankaenterprises.features.homelocation.presentation.HomeLocationFragment
import com.fsmpriyankaenterprises.features.homelocation.presentation.HomeLocationMapFragment
import com.fsmpriyankaenterprises.features.know_your_state.KnowYourStateFragment
import com.fsmpriyankaenterprises.features.lead.LeadFrag
import com.fsmpriyankaenterprises.features.lead.ViewLeadFrag
import com.fsmpriyankaenterprises.features.leaveapplynew.LeaveHome
import com.fsmpriyankaenterprises.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.fsmpriyankaenterprises.features.localshops.LocalShopListFragment
import com.fsmpriyankaenterprises.features.localshops.LocalShopListMapFragment
import com.fsmpriyankaenterprises.features.localshops.NearByShopsMapFragment
import com.fsmpriyankaenterprises.features.location.*
import com.fsmpriyankaenterprises.features.location.api.LocationRepoProvider
import com.fsmpriyankaenterprises.features.location.model.*
import com.fsmpriyankaenterprises.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.fsmpriyankaenterprises.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.fsmpriyankaenterprises.features.login.ShopFeedbackEntity
import com.fsmpriyankaenterprises.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.fsmpriyankaenterprises.features.login.presentation.LoginActivity
import com.fsmpriyankaenterprises.features.logout.presentation.api.LogoutRepositoryProvider
import com.fsmpriyankaenterprises.features.logoutsync.presentation.LogoutSyncFragment
import com.fsmpriyankaenterprises.features.marketAssist.MarketAssistTabFrag
import com.fsmpriyankaenterprises.features.marketAssist.ShopDtlsMarketAssistFrag
import com.fsmpriyankaenterprises.features.marketAssist.ShopListMarketAssistFrag
import com.fsmpriyankaenterprises.features.marketing.presentation.MarketingPagerFragment
import com.fsmpriyankaenterprises.features.meetinglist.prsentation.MeetingListFragment
import com.fsmpriyankaenterprises.features.member.MapViewForTeamFrag
import com.fsmpriyankaenterprises.features.member.model.TeamLocDataModel
import com.fsmpriyankaenterprises.features.member.model.TeamShopListDataModel
import com.fsmpriyankaenterprises.features.member.presentation.*
import com.fsmpriyankaenterprises.features.menuBeat.MenuBeatFrag
import com.fsmpriyankaenterprises.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.fsmpriyankaenterprises.features.micro_learning.presentation.MicroLearningListFragment
import com.fsmpriyankaenterprises.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.fsmpriyankaenterprises.features.myallowancerequest.MyallowanceRequestFragment
import com.fsmpriyankaenterprises.features.myjobs.model.CustomerDataModel
import com.fsmpriyankaenterprises.features.myjobs.presentation.*
import com.fsmpriyankaenterprises.features.myorder.presentation.MyOrderListFragment
import com.fsmpriyankaenterprises.features.myprofile.presentation.MyProfileFragment
import com.fsmpriyankaenterprises.features.nearbyshops.api.ShopListRepositoryProvider
import com.fsmpriyankaenterprises.features.nearbyshops.model.ShopData
import com.fsmpriyankaenterprises.features.nearbyshops.model.ShopListResponse
import com.fsmpriyankaenterprises.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.fsmpriyankaenterprises.features.nearbyshops.presentation.BeatListFragment
import com.fsmpriyankaenterprises.features.nearbyshops.presentation.NearByShopsListFragment
import com.fsmpriyankaenterprises.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.fsmpriyankaenterprises.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.fsmpriyankaenterprises.features.newcollection.CollectionDetailsStatusFragment
import com.fsmpriyankaenterprises.features.newcollection.CollectionShopListFragment
import com.fsmpriyankaenterprises.features.newcollection.NewCollectionListFragment
import com.fsmpriyankaenterprises.features.newcollectionreport.*
import com.fsmpriyankaenterprises.features.notification.NotificationFragment
import com.fsmpriyankaenterprises.features.orderList.NewDateWiseOrderListFragment
import com.fsmpriyankaenterprises.features.orderList.NewOrderListFragment
import com.fsmpriyankaenterprises.features.orderList.OrderListFragment
import com.fsmpriyankaenterprises.features.orderdetail.presentation.OrderDetailFragment
import com.fsmpriyankaenterprises.features.orderhistory.ActivityMapFragment
import com.fsmpriyankaenterprises.features.orderhistory.OrderhistoryFragment
import com.fsmpriyankaenterprises.features.orderhistory.TimeLineFragment
import com.fsmpriyankaenterprises.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.fsmpriyankaenterprises.features.orderhistory.model.LocationData
import com.fsmpriyankaenterprises.features.pendinglocationinout.PendingOutLocationFrag
import com.fsmpriyankaenterprises.features.performance.GpsStatusFragment
import com.fsmpriyankaenterprises.features.performance.PerformanceFragment
import com.fsmpriyankaenterprises.features.performance.api.UpdateGpsStatusRepoProvider
import com.fsmpriyankaenterprises.features.performance.model.UpdateGpsInputParamsModel
import com.fsmpriyankaenterprises.features.performanceAPP.OwnPerformanceFragment
import com.fsmpriyankaenterprises.features.performanceAPP.PerformanceAppFragment
import com.fsmpriyankaenterprises.features.performanceAPP.allPerformanceFrag
import com.fsmpriyankaenterprises.features.permissionList.ViewPermissionFragment
import com.fsmpriyankaenterprises.features.photoReg.*
import com.fsmpriyankaenterprises.features.privacypolicy.PrivacypolicyWebviewFrag
import com.fsmpriyankaenterprises.features.quotation.presentation.*
import com.fsmpriyankaenterprises.features.reimbursement.presentation.*
import com.fsmpriyankaenterprises.features.report.presentation.*
import com.fsmpriyankaenterprises.features.returnsOrder.*
import com.fsmpriyankaenterprises.features.settings.presentation.SettingsFragment
import com.fsmpriyankaenterprises.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.fsmpriyankaenterprises.features.shopdetail.presentation.*
import com.fsmpriyankaenterprises.features.shopdetail.presentation.api.EditShopRepoProvider
import com.fsmpriyankaenterprises.features.stock.StockDetailsFragment
import com.fsmpriyankaenterprises.features.stock.StockListFragment
import com.fsmpriyankaenterprises.features.stockAddCurrentStock.AddShopStockFragment
import com.fsmpriyankaenterprises.features.stockAddCurrentStock.UpdateShopStockFragment
import com.fsmpriyankaenterprises.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.fsmpriyankaenterprises.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.fsmpriyankaenterprises.features.stockCompetetorStock.AddCompetetorStockFragment
import com.fsmpriyankaenterprises.features.stockCompetetorStock.CompetetorStockFragment
import com.fsmpriyankaenterprises.features.stockCompetetorStock.ViewComStockProductDetails
import com.fsmpriyankaenterprises.features.survey.SurveyFrag
import com.fsmpriyankaenterprises.features.survey.SurveyViewDtlsFrag
import com.fsmpriyankaenterprises.features.survey.SurveyViewFrag
import com.fsmpriyankaenterprises.features.task.presentation.AddTaskFragment
import com.fsmpriyankaenterprises.features.task.presentation.CalenderTaskFragment
import com.fsmpriyankaenterprises.features.task.presentation.EditTaskFragment
import com.fsmpriyankaenterprises.features.task.presentation.TaskListFragment
import com.fsmpriyankaenterprises.features.taskManagement.TaskManagementFrag
import com.fsmpriyankaenterprises.features.taskManagement.ViewTaskManagementFrag
import com.fsmpriyankaenterprises.features.timesheet.presentation.AddTimeSheetFragment
import com.fsmpriyankaenterprises.features.timesheet.presentation.EditTimeSheetFragment
import com.fsmpriyankaenterprises.features.timesheet.presentation.TimeSheetListFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.CartFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.OrderTypeListFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.ViewAllOrderListFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.ViewCartFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.fsmpriyankaenterprises.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.fsmpriyankaenterprises.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.fsmpriyankaenterprises.features.viewPPDDStock.ViewOutstandingFragment
import com.fsmpriyankaenterprises.features.viewPPDDStock.ViewPPDDListFragment
import com.fsmpriyankaenterprises.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.fsmpriyankaenterprises.features.viewPPDDStock.ViewStockFragment
import com.fsmpriyankaenterprises.features.weather.presentation.WeatherFragment
import com.fsmpriyankaenterprises.mappackage.MapActivity
import com.fsmpriyankaenterprises.mappackage.MapActivityWithoutPath
import com.fsmpriyankaenterprises.mappackage.SendBrod
import com.fsmpriyankaenterprises.widgets.AppCustomEditText
import com.fsmpriyankaenterprises.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xfsmpriyankaenterpriseslogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmpriyankaenterpriseslogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.fsmpriyankaenterprises/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmpriyankaenterpriseslogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmpriyankaenterpriseslogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmpriyankaenterpriseslogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfsmpriyankaenterpriseslogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
