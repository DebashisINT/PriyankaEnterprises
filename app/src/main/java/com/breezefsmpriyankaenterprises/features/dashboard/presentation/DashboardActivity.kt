package com.breezefsmpriyankaenterprises.features.dashboard.presentation
...
import com.breezefsmpriyankaenterprises.*
import com.breezefsmpriyankaenterprises.R
import com.breezefsmpriyankaenterprises.app.*
import com.breezefsmpriyankaenterprises.app.NewFileUtils.browseDocuments
import com.breezefsmpriyankaenterprises.app.NewFileUtils.browsePDFDocuments
import com.breezefsmpriyankaenterprises.app.NewFileUtils.getExtension
import com.breezefsmpriyankaenterprises.app.domain.*
import com.breezefsmpriyankaenterprises.app.types.DashboardType
import com.breezefsmpriyankaenterprises.app.types.FragType
import com.breezefsmpriyankaenterprises.app.types.TopBarConfig
import com.breezefsmpriyankaenterprises.app.uiaction.DisplayAlert
import com.breezefsmpriyankaenterprises.app.utils.*
import com.breezefsmpriyankaenterprises.app.utils.AppUtils.Companion.isProfile
import com.breezefsmpriyankaenterprises.base.BaseResponse
import com.breezefsmpriyankaenterprises.base.presentation.BaseActivity
import com.breezefsmpriyankaenterprises.base.presentation.BaseFragment
import com.breezefsmpriyankaenterprises.features.NewQuotation.*
import com.breezefsmpriyankaenterprises.features.NewQuotation.api.GetQuotRegProvider
import com.breezefsmpriyankaenterprises.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefsmpriyankaenterprises.features.SearchLocation.SearchLocationFragment
import com.breezefsmpriyankaenterprises.features.SearchLocation.locationInfoModel
import com.breezefsmpriyankaenterprises.features.TA.ViewAllTAListFragment
import com.breezefsmpriyankaenterprises.features.achievement.AchievementFragment
import com.breezefsmpriyankaenterprises.features.activities.presentation.*
import com.breezefsmpriyankaenterprises.features.addAttendence.*
import com.breezefsmpriyankaenterprises.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefsmpriyankaenterprises.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefsmpriyankaenterprises.features.addAttendence.model.GetReportToFCMResponse
import com.breezefsmpriyankaenterprises.features.addAttendence.model.GetReportToResponse
import com.breezefsmpriyankaenterprises.features.addAttendence.model.Leave_list_Response
import com.breezefsmpriyankaenterprises.features.addorder.presentation.AddOrderFragment
...
import com.breezefsmpriyankaenterprises.features.addshop.presentation.AddShopFragment
import com.breezefsmpriyankaenterprises.features.addshop.presentation.OTPVerificationDialog
import com.breezefsmpriyankaenterprises.features.addshop.presentation.ScanImageFragment
import com.breezefsmpriyankaenterprises.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefsmpriyankaenterprises.features.alarm.model.AlarmData
import com.breezefsmpriyankaenterprises.features.alarm.presetation.AttendanceReportFragment
import com.breezefsmpriyankaenterprises.features.alarm.presetation.PerformanceReportFragment
import com.breezefsmpriyankaenterprises.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefsmpriyankaenterprises.features.alarm.presetation.VisitReportFragment
import com.breezefsmpriyankaenterprises.features.attendance.AttendanceFragment
import com.breezefsmpriyankaenterprises.features.attendance.api.AttendanceRepositoryProvider
import com.breezefsmpriyankaenterprises.features.attendance.model.AttendanceRequest
import com.breezefsmpriyankaenterprises.features.attendance.model.AttendanceResponse
import com.breezefsmpriyankaenterprises.features.averageshop.presentation.AverageShopFragment
import com.breezefsmpriyankaenterprises.features.avgorder.presentation.AverageOrderFragment
import com.breezefsmpriyankaenterprises.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefsmpriyankaenterprises.features.beatCustom.TeamBeatListFragment
import com.breezefsmpriyankaenterprises.features.billing.presentation.AddBillingFragment
import com.breezefsmpriyankaenterprises.features.billing.presentation.BillingDetailsFragment
import com.breezefsmpriyankaenterprises.features.billing.presentation.BillingListFragment
import com.breezefsmpriyankaenterprises.features.changepassword.presentation.ChangePasswordDialog
import com.breezefsmpriyankaenterprises.features.chat.model.ChatListDataModel
import com.breezefsmpriyankaenterprises.features.chat.model.ChatUserDataModel
import com.breezefsmpriyankaenterprises.features.chat.model.GroupUserDataModel
import com.breezefsmpriyankaenterprises.features.chat.presentation.*
import com.breezefsmpriyankaenterprises.features.chatbot.presentation.ChatBotFragment
import com.breezefsmpriyankaenterprises.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefsmpriyankaenterprises.features.chatbot.presentation.ReportsFragment
import com.breezefsmpriyankaenterprises.features.chatbot.presentation.SelectLanguageDialog
import com.breezefsmpriyankaenterprises.features.commondialog.presentation.CommonDialog
import com.breezefsmpriyankaenterprises.features.commondialog.presentation.CommonDialogClickListener
import com.breezefsmpriyankaenterprises.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefsmpriyankaenterprises.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefsmpriyankaenterprises.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefsmpriyankaenterprises.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefsmpriyankaenterprises.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefsmpriyankaenterprises.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefsmpriyankaenterprises.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefsmpriyankaenterprises.features.damageProduct.ShopDamageProductListFrag
import com.breezefsmpriyankaenterprises.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefsmpriyankaenterprises.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefsmpriyankaenterprises.features.device_info.presentation.DeviceInfoListFragment
import com.breezefsmpriyankaenterprises.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefsmpriyankaenterprises.features.document.DocumentRepoFeatureNewFragment
import com.breezefsmpriyankaenterprises.features.document.presentation.DocumentListFragment
import com.breezefsmpriyankaenterprises.features.document.presentation.DocumentTypeListFragment
import com.breezefsmpriyankaenterprises.features.document.presentation.OpenFileWebViewFragment
import com.breezefsmpriyankaenterprises.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefsmpriyankaenterprises.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefsmpriyankaenterprises.features.dymanicSection.presentation.DynamicListFragment
import com.breezefsmpriyankaenterprises.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefsmpriyankaenterprises.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefsmpriyankaenterprises.features.home.presentation.HomeFragment
import com.breezefsmpriyankaenterprises.features.homelocation.presentation.HomeLocationFragment
import com.breezefsmpriyankaenterprises.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefsmpriyankaenterprises.features.know_your_state.KnowYourStateFragment
import com.breezefsmpriyankaenterprises.features.lead.LeadFrag
import com.breezefsmpriyankaenterprises.features.lead.ViewLeadFrag
import com.breezefsmpriyankaenterprises.features.leaveapplynew.LeaveHome
import com.breezefsmpriyankaenterprises.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefsmpriyankaenterprises.features.localshops.LocalShopListFragment
import com.breezefsmpriyankaenterprises.features.localshops.LocalShopListMapFragment
import com.breezefsmpriyankaenterprises.features.localshops.NearByShopsMapFragment
import com.breezefsmpriyankaenterprises.features.location.*
import com.breezefsmpriyankaenterprises.features.location.api.LocationRepoProvider
import com.breezefsmpriyankaenterprises.features.location.model.*
import com.breezefsmpriyankaenterprises.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefsmpriyankaenterprises.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefsmpriyankaenterprises.features.login.ShopFeedbackEntity
import com.breezefsmpriyankaenterprises.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefsmpriyankaenterprises.features.login.presentation.LoginActivity
import com.breezefsmpriyankaenterprises.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefsmpriyankaenterprises.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefsmpriyankaenterprises.features.marketAssist.MarketAssistTabFrag
import com.breezefsmpriyankaenterprises.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefsmpriyankaenterprises.features.marketAssist.ShopListMarketAssistFrag
import com.breezefsmpriyankaenterprises.features.marketing.presentation.MarketingPagerFragment
import com.breezefsmpriyankaenterprises.features.meetinglist.prsentation.MeetingListFragment
import com.breezefsmpriyankaenterprises.features.member.MapViewForTeamFrag
import com.breezefsmpriyankaenterprises.features.member.model.TeamLocDataModel
import com.breezefsmpriyankaenterprises.features.member.model.TeamShopListDataModel
import com.breezefsmpriyankaenterprises.features.member.presentation.*
import com.breezefsmpriyankaenterprises.features.menuBeat.MenuBeatFrag
import com.breezefsmpriyankaenterprises.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefsmpriyankaenterprises.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefsmpriyankaenterprises.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefsmpriyankaenterprises.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefsmpriyankaenterprises.features.myjobs.model.CustomerDataModel
import com.breezefsmpriyankaenterprises.features.myjobs.presentation.*
import com.breezefsmpriyankaenterprises.features.myorder.presentation.MyOrderListFragment
import com.breezefsmpriyankaenterprises.features.myprofile.presentation.MyProfileFragment
import com.breezefsmpriyankaenterprises.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefsmpriyankaenterprises.features.nearbyshops.model.ShopData
import com.breezefsmpriyankaenterprises.features.nearbyshops.model.ShopListResponse
import com.breezefsmpriyankaenterprises.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefsmpriyankaenterprises.features.nearbyshops.presentation.BeatListFragment
import com.breezefsmpriyankaenterprises.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefsmpriyankaenterprises.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefsmpriyankaenterprises.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefsmpriyankaenterprises.features.newcollection.CollectionDetailsStatusFragment
import com.breezefsmpriyankaenterprises.features.newcollection.CollectionShopListFragment
import com.breezefsmpriyankaenterprises.features.newcollection.NewCollectionListFragment
import com.breezefsmpriyankaenterprises.features.newcollectionreport.*
import com.breezefsmpriyankaenterprises.features.notification.NotificationFragment
import com.breezefsmpriyankaenterprises.features.orderList.NewDateWiseOrderListFragment
import com.breezefsmpriyankaenterprises.features.orderList.NewOrderListFragment
import com.breezefsmpriyankaenterprises.features.orderList.OrderListFragment
import com.breezefsmpriyankaenterprises.features.orderdetail.presentation.OrderDetailFragment
import com.breezefsmpriyankaenterprises.features.orderhistory.ActivityMapFragment
import com.breezefsmpriyankaenterprises.features.orderhistory.OrderhistoryFragment
import com.breezefsmpriyankaenterprises.features.orderhistory.TimeLineFragment
import com.breezefsmpriyankaenterprises.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefsmpriyankaenterprises.features.orderhistory.model.FetchLocationRequest
import com.breezefsmpriyankaenterprises.features.orderhistory.model.FetchLocationResponse
import com.breezefsmpriyankaenterprises.features.orderhistory.model.LocationData
import com.breezefsmpriyankaenterprises.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefsmpriyankaenterprises.features.performance.GpsStatusFragment
import com.breezefsmpriyankaenterprises.features.performance.PerformanceFragment
import com.breezefsmpriyankaenterprises.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefsmpriyankaenterprises.features.performance.model.UpdateGpsInputParamsModel
import com.breezefsmpriyankaenterprises.features.performanceAPP.OwnPerformanceFragment
import com.breezefsmpriyankaenterprises.features.performanceAPP.PerformanceAppFragment
import com.breezefsmpriyankaenterprises.features.performanceAPP.allPerformanceFrag
import com.breezefsmpriyankaenterprises.features.permissionList.ViewPermissionFragment
import com.breezefsmpriyankaenterprises.features.photoReg.*
import com.breezefsmpriyankaenterprises.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefsmpriyankaenterprises.features.quotation.presentation.*
import com.breezefsmpriyankaenterprises.features.reimbursement.presentation.*
import com.breezefsmpriyankaenterprises.features.report.presentation.*
import com.breezefsmpriyankaenterprises.features.returnsOrder.*
import com.breezefsmpriyankaenterprises.features.settings.presentation.SettingsFragment
import com.breezefsmpriyankaenterprises.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefsmpriyankaenterprises.features.shopdetail.presentation.*
import com.breezefsmpriyankaenterprises.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmpriyankaenterprises.features.stock.StockDetailsFragment
import com.breezefsmpriyankaenterprises.features.stock.StockListFragment
import com.breezefsmpriyankaenterprises.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefsmpriyankaenterprises.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefsmpriyankaenterprises.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefsmpriyankaenterprises.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefsmpriyankaenterprises.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefsmpriyankaenterprises.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefsmpriyankaenterprises.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefsmpriyankaenterprises.features.survey.SurveyFrag
import com.breezefsmpriyankaenterprises.features.survey.SurveyViewDtlsFrag
import com.breezefsmpriyankaenterprises.features.survey.SurveyViewFrag
import com.breezefsmpriyankaenterprises.features.task.presentation.AddTaskFragment
import com.breezefsmpriyankaenterprises.features.task.presentation.CalenderTaskFragment
import com.breezefsmpriyankaenterprises.features.task.presentation.EditTaskFragment
import com.breezefsmpriyankaenterprises.features.task.presentation.TaskListFragment
import com.breezefsmpriyankaenterprises.features.taskManagement.TaskManagementFrag
import com.breezefsmpriyankaenterprises.features.taskManagement.ViewTaskManagementFrag
import com.breezefsmpriyankaenterprises.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefsmpriyankaenterprises.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefsmpriyankaenterprises.features.timesheet.presentation.TimeSheetListFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.CartFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.OrderTypeListFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.ViewCartFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefsmpriyankaenterprises.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefsmpriyankaenterprises.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefsmpriyankaenterprises.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefsmpriyankaenterprises.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefsmpriyankaenterprises.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefsmpriyankaenterprises.features.viewPPDDStock.ViewStockFragment
import com.breezefsmpriyankaenterprises.features.weather.presentation.WeatherFragment
import com.breezefsmpriyankaenterprises.mappackage.MapActivity
import com.breezefsmpriyankaenterprises.mappackage.MapActivityWithoutPath
import com.breezefsmpriyankaenterprises.mappackage.SendBrod
import com.breezefsmpriyankaenterprises.widgets.AppCustomEditText
import com.breezefsmpriyankaenterprises.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefsmpriyankaenterpriseslogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmpriyankaenterpriseslogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefsmpriyankaenterprises/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmpriyankaenterpriseslogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmpriyankaenterpriseslogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmpriyankaenterpriseslogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmpriyankaenterpriseslogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
